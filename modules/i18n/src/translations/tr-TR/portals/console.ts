...
export const console: ConsoleNS = {
    ...
    loginFlow: {
        adaptiveLoginFlowSelectConfirmationModal: {
            content: "Seçilen şablon, düzenleyicideki mevcut komut dosyasını ve yapılandırdığınız giriş adımlarını değiştirecektir. Devam etmek için <1>Onayla</1>’ya tıklayın.",
            heading: "Emin misiniz?",
            message: "Bu işlem geri alınamaz."
        },
        basicLoginFlowSelectConfirmationModal: {
            content: "Seçilen şablon, yapılandırdığınız mevcut giriş adımlarını değiştirecektir. Devam etmek için <1>Onayla</1>’ya tıklayın.",
            heading: "Emin misiniz?",
            message: "Bu işlem geri alınamaz."
        },
        options: {
            ...
            displayName: "{{displayName}} ile Giriş Yap",
            divider: "VEYA"
        },
        modes: {
            legacy: {
                label: "Klasik Düzenleyici"
            },
            visual: {
                label: "Görsel Düzenleyici"
            },
            switchConfirmationModal: {
                assertionHint: "Evet, anladım. Değiştirmek istiyorum.",
                content: "Bu işlem geri alınamaz ve mevcut akıştaki kaydedilmemiş değişiklikleri kalıcı olarak kaybedersiniz.",
                primaryActionButtonText: "Onayla",
                secondaryActionButtonText: "İptal",
                title: "Emin misiniz?",
                warningMessage: "Eğer <1>{{mode}}</1> moduna geçiş yaparsanız, mevcut akıştaki kaydedilmemiş değişiklikleri kaybedersiniz. Lütfen dikkatli olun."
            }
        },
        nodes: {
            controls: {
                attributeSelector: {
                    label: "Bu adımdan öznitelikleri seç"
                },
                enableBackupCodes: {
                    label: "Yedek kodları etkinleştir"
                },
                userAttributeSelector: {
                    label: "Bu adımdan kullanıcı tanımlayıcısını seç"
                }
            },
            emailOTP: {
                controls: {
                    optionRemoveTooltipContent: "Kaldır"
                },
                form: {
                    actions: {
                        primary: "Devam Et",
                        secondary: "Kodu Yeniden Gönder"
                    },
                    fields: {
                        code: {
                            label: "E-posta ID'nize gönderilen kodu girin (john*****@gmail.com)",
                            placeholder: ""
                        }
                    }
                },
            ...
            identifierFirst: {
                controls: {
                    optionRemoveTooltipContent: "Kaldır",
                    optionSwitchTooltipContent: "Kullanıcı Adı & Şifre'ye geç"
                },
                form: {
                    actions: {
                        primary: "Giriş Yap"
                    ...
                    fields: {
                        rememberMe: {
                            label: "Bu bilgisayarda beni hatırla"
                        },
                        username: {
                            label: "Kullanıcı Adı",
            ...
            signIn: {
                controls: {
                    optionRemoveTooltipContent: "Kaldır",
                    optionSwitchTooltipContent: "Tanımlayıcı İlk'e geç"
                },
                form: {
                    actions: {
                        primary: "Giriş Yap"
            ...
            smsOTP: {
                ...
                form: {
                    ...
                    fields: {
                        code: {
                            label: "Mobil telefonunuza gönderilen kodu girin (******3830)",
                            placeholder: ""
                        }
                    }
                },
            ...
            totp: {
                ...
                form: {
                    ...
                    fields: {
                        code: {
                            label: "Doğrulayıcı uygulamanız tarafından oluşturulan doğrulama kodunu girin.",
                            placeholder: ""
                        }
                    },
                    help: "TOTP doğrulayıcınızı henüz kurmadınız mı? Destek ile iletişime geçin"
                },
                header: "Kimliğinizi Doğrulayın"
            }
        },
        revertConfirmationModal: {
            assertionHint: "Evet, anladım. Geri almak istiyorum.",
            content: "Bu işlem geri alınamaz ve yaptığınız ilerlemeyi kalıcı olarak kaybedersiniz.",
            primaryActionButtonText: "Onayla",
            secondaryActionButtonText: "İptal",
            title: "Emin misiniz?",
            warningMessage: "Varsayılana geri dönerseniz, ilerlemenizi geri alamazsınız. Lütfen dikkatli olun."
        },
        steps: {
            controls: {
                addOption: "Giriş Seçeneği Ekle",
                remove: "Kaldır",
                signUp: {
                    hint: "Bir hesabınız yok mu?",
                    label: "Kaydol"
                }
            }
        },
        predefinedFlows: {
            ...
            basic: {
                header: "Temel Giriş Akışları"
            },
            categories: {
                basic: {
                    label: "Temel Giriş Ekle"
                },
                mfa: {
                    label: "Çok Faktörlü Giriş Ekle"
                },
                passwordless: {
                    label: "Şifresiz Giriş Ekle"
                },
                social: {
                    label: "Sosyal Giriş Ekle"
                }
            },
            header: "Önceden Tanımlanmış Akışlar",
            panelHeader: "Önceden Tanımlanmış Akışlar"
        },
        scriptEditor: {
            panelHeader: "Komut Düzenleyici",
            secretSelector: {
                actions: {
                    create: {
                        label: "Yeni Sır Oluştur"
                    }
                },
                emptyPlaceholder: {
                    header: "Kullanılabilir sır yok.",
                    description: "Erişim anahtarlarını güvenli bir şekilde sır olarak saklayın. Bir sır, koşullu doğrulama komut dosyalarındaki <1>callChoreo()</1> işlevinde tüketici sırrını değiştirebilir."
                },
                label: "Sır Ekle"
            },
            themes: {
                dark: {
                    label: "Koyu (Visual Studio)"
                },
                highContrast: {
                    label: "Yüksek Kontrast"
                },
                light: {
                    label: "Açık (Visual Studio)"
                }
            }
        },
        visualEditor: {
    ...
    manage: {
        features: {
            ...
            oidcScopes: {
                viewAttributes: "Öznitelikleri Görüntüle",
                manageAttributes: "Öznitelikleri Yönet",
                addAttributes: {
                    description: "Lütfen {{name}} kapsamıyla ilişkilendirmek istediğiniz kullanıcı özniteliklerini seçin."
                },
                buttons: {
                ...
                confirmationModals: {
                    deleteClaim: {
                        assertionHint: "Lütfen onaylamak için <1>{{ name }}</1> yazın.",
                        content: "Bu iddiayı silerseniz, geri alamazsınız. Lütfen dikkatli olun.",
                        header: "Emin misiniz?",
                        message: "Bu işlem geri alınamaz ve OIDC iddiasını kalıcı olarak silecektir."
                    },
                    deleteScope: {
                        assertionHint: "Lütfen eyleminizi onaylayın.",
                        content: "Bu kapsamı silerseniz, geri alamazsınız. Lütfen dikkatli olun.",
                        header: "Emin misiniz?",
                        message: "Bu işlem geri alınamaz ve OIDC kapsamını kalıcı olarak silecektir."
                    }
                },
                editScope: {
                    claimList: {
                        ...
                        emptyPlaceholder: {
                            ...
                            subtitles: {
                                ...
                                1: "Görüntülemek için lütfen gerekli öznitelikleri ekleyin."
                            },
                            title: "OIDC Öznitelik Yok"
                        },
                        emptySearch: {
                            action: "Tümünü görüntüle",
                            subtitles: {
                                0: "Aradığınız öznitelik bulunamadı.",
                                1: "Lütfen farklı bir isim deneyin."
                            },
                            title: "Sonuç bulunamadı"
                        },
                        popupDelete: "Öznitelik sil",
                        searchClaims: "öznitelik ara",
                        subTitle: "Bir OIDC kapsamının özniteliklerini ekle veya kaldır",
                        title: "{{ name }}"
                    }
                },
                forms: {
                    addScopeForm: {
                        inputs: {
                            ...
                            displayName: {
                                label: "Görünen isim",
                                placeholder: "Görünen isim girin",
                                validations: {
                            ...
                            scopeName: {
                                label: "Kapsam",
                                placeholder: "Kapsam girin",
                                validations: {
                                    empty: "Bu alan boş bırakılamaz",
                                    invalid: "Kapsam yalnızca alfanümerik karakterler ve _ içerebilir. " +
                                  "Ve uzunluğu 3 ile 40 karakter arasında olmalıdır."
                                }
                            }
                        }
                    }
                ...
                list: {
                    ...
                    empty: {
                        ...
                        subtitles: {
                            0: "Sistemde OIDC Kapsamı yok.",
                            1: "Lütfen yeni OIDC kapsamları ekleyin ve burada görüntüleyin."
                        },
                        title: "OIDC Kapsamı Yok"
                    },
                    searchPlaceholder: "Kapsam ile ara"
                },
                notifications: {
                    addOIDCClaim: {
                        error: {
                    ...
                    addOIDCScope: {
                        ...
                        success: {
                            description: "Yeni OIDC kapsamı başarıyla oluşturuldu.",
                            message: "Oluşturma başarılı"
                        }
                    },
                    claimsMandatory: {
                        error: {
                            description: "Bir kapsam eklemek için, kapsamın en az bir özniteliğe sahip olması gerekir.",
                            message: "En az bir öznitelik seçmeniz gerekiyor."
                        }
                    },
                    deleteOIDCScope: {
                        error: {
                    ...
                    fetchOIDCScope: {
                        ...
                        genericError: {
                            description: "OIDC kapsamı detayları alınırken bir hata oluştu.",
                            message: "Bir şeyler yanlış gitti"
                        },
                        success: {
                            description: "OIDC kapsamı detayları başarıyla alındı.",
                            message: "Alma başarılı"
                        }
                    },
                    fetchOIDCScopes: {
                        ...
                        genericError: {
                            description: "OIDC kapsamları alınırken bir hata oluştu.",
                            message: "Bir şeyler yanlış gitti"
                        },
                        success: {
                            description: "OIDC kapsamları başarıyla alındı.",
                            message: "Alma başarılı"
                        }
                    },
                    fetchOIDClaims: {
                        ...
                        genericError: {
                            description: "OIDC öznitelikleri alınırken bir hata oluştu.",
                            message: "Bir şeyler yanlış gitti"
                        },
                        success: {
                            description: "OIDC öznitelikleri başarıyla alındı.",
                            message: "Alma başarılı"
                        }
                    },
                    updateOIDCScope: {
                        ...
                        success: {
                            description: "OIDC kapsamı başarıyla güncellendi.",
                            message: "Güncelleme başarılı"
                        }
                    }
                },
                placeholders: {
                    emptyList: {
                        ...
                        subtitles: {
                            0: "Şu anda herhangi bir OIDC kapsamı bulunmamaktadır.",
                            1: "Oluşturma sihirbazındaki adımları takip ederek kolayca yeni bir OIDC kapsamı ekleyebilirsiniz.",
                            2: "Oluşturma sihirbazındaki adımları takip edin."
                        },
                ...
                wizards: {
                    addScopeWizard: {
                        ...
                        claimList: {
                            searchPlaceholder: "Öznitelikleri ara",
                            table: {
                                emptyPlaceholders: {
                                    assigned: "Tüm mevcut öznitelikler bu OIDC kapsamına atanmıştır.",
                    ...
                    users: {
                        assignUserModal: {
                            ...
                            list: {
                                ...
                                searchByEmailPlaceholder: "E-posta adresine göre kullanıcıları ara"
                            },
                            subHeading: "{{type}}'a atanmış yeni kullanıcılar ekleyin veya mevcut kullanıcıları kaldırın."
                        }
                    },                  
                    wizardSteps: {
                        "0": "Temel Ayrıntılar",
            ...
            serverConfigs: {
                adminAdvisory: {  
                    configurationEditSection: {
                        backButtonLabel: "Yönetici Bilgilendirme Afişine Geri Dön",
                        pageHeading: "Yönetici Bilgilendirme Afişi",
                        pageSubheading: "Oturum açma sayfasında gösterilecek yönetici bilgilendirme afişini yapılandırın ve özelleştirin.",
                        form: {
                            bannerContent: {
                                label: "Afiş içeriği",
                                hint: "Bu içerik, oturum açma sayfasındaki afişte gösterilecek içeriktir.",
                                placeholder: "Uyarı - bu aracın yetkisiz kullanımı kesinlikle yasaktır."
                            }
                        }
                    },
                    configurationSection: {
                        disabled: "Devre Dışı",
                        description: "Yönetici bilgilendirme afişini etkinleştirin ve yapılandırın.",
                        enabled: "Etkin",
                        heading: "Yönetici Bilgilendirme Afişi"
                    },   
                    notifications: {
                        disbleAdminAdvisoryBanner: {
                            error: {
                                description: "{{ description }}",
                                message: "Yönetici bilgilendirme afişini devre dışı bırakma hatası."
                            },
                            genericError: {
                                description: "Yönetici bilgilendirme afişini devre dışı bırakırken bir hata oluştu.",
                                message: "Bir şeyler yanlış gitti"
                            },
                            success: {
                                description: "Yönetici bilgilendirme afişi başarıyla devre dışı bırakıldı.",
                                message: "Yönetici bilgilendirme afişi devre dışı bırakıldı"
                            }
                        },                    
                        enableAdminAdvisoryBanner: {
                            error: {
                                description: "{{ description }}",
                                message: "Yönetici bilgilendirme afişini etkinleştirirken hata oluştu."
                            },
                            genericError: {
                                description: "Yönetici bilgilendirme afişini etkinleştirirken bir hata oluştu.",
                                message: "Bir şeyler yanlış gitti"
                            },
                            success: {
                                description: "Yönetici bilgilendirme afişi başarıyla etkinleştirildi.",
                                message: "Yönetici bilgilendirme afişi etkinleştirildi"
                            }
                        },
                        getConfigurations: {
                            error: {
                                description: "{{ description }}",
                                message: "Yönetici bilgilendirme afişinin yapılandırmalarını alırken hata oluştu."
                            },
                            genericError: {
                                description: "Yönetici bilgilendirme afişinin yapılandırmalarını alırken bir hata oluştu.",
                                message: "Bir şeyler yanlış gitti"
                            },
                            success: {
                                description: "",
                        ...
                        updateConfigurations: {
                            error: {
                                description: "{{ description }}",
                                message: "Yönetici bilgilendirme afişinin yapılandırmalarını güncellerken hata oluştu."
                            },
                            genericError: {
                                description: "Yönetici bilgilendirme afişinin yapılandırmalarını güncellerken bir hata oluştu.",
                                message: "Bir şeyler yanlış gitti"
                            },
                            success: {
                                description: "Yönetici bilgilendirme afişinin yapılandırmaları başarıyla güncellendi.",
                                message: "Afiş başarıyla güncellendi"
                            }
                        }
                    },     
                    pageHeading: "Yönetici Bilgilendirme Afişi",
                    pageSubheading: "Oturum açma sayfasında gösterilecek yönetici bilgilendirme afişini yapılandırın."
                },            
                realmConfiguration: {
                    actionTitles: {
                        config: "Daha"
            ...
            insights: {
                pageTitle: "İçgörüler",
                title: "İçgörüler",
                description: "Kullanıcı davranışını kullanım istatistikleriyle daha iyi anlayın.",
                durationMessage: "<1>{{ startTimestamp }}</1> ile <1>{{ endTimestamp }}</1> arasındaki sonuçları gösteriyor",
                durationOption: "Son {{ duration }} gün",
                lastFetchedMessage: {
                    label: "{{ time }}'da son alındı",
                    tooltipText: "En son etkinliğin içgörüleri grafiklerde yansıtılması birkaç dakika sürebilir"
                },
                advancedFilter: {
                ...
                activityType: {
                    login: {
                        filters: {
                            ...
                            authenticator: {
                                attributeName: "Bağlantı Türü",
                                values: {
                                    basic: "Kullanıcı Adı & Parola",
                                    identifierFirst: "Tanımlayıcı İlk",
                                    fido2: "FIDO2",
                                    magicLink: "Sihirli Link",
                                    emailOtp: "E-posta OTP",
                                    smsOtp: "SMS OTP",
                                    totp: "TOTP",
                                    backupCodes: "Yedek Kod",
                                    google: "Google",
                                    facebook: "Facebook",
                                    github: "GitHub",
                                    apple: "Apple",
                                    ...
                                    saml: "SAML IdP",
                                    hypr: "HYPR",
                                    organizationLogin: "Organizasyon Girişi"
                                }
                            },
                            identityProvider: "Bağlantı ID"
                        }
                    },
                    registration: {
                        filters: {
                            onboardingMethod: {
                                attributeName: "Açılış Yöntemi",
                                values: {
                                    adminInitiated: "Yönetici tarafından",
                                    userInvited: "E-posta daveti",
                                    selfSignUp: "Kendi kendine kayıt"
                                }
                            }
                        }
                    }
                ...
                graphs: {
                    ...
                    successLogins: {
                        ...
                        titleHint: "Seçilen dönem içinde organizasyonunuza başarılı girişlerin sayısı"
                    },
                    failedLogins: {
                    ...
                    signups: {
                        ...
                        titleHint: "Seçilen dönem içerisinde meydana gelen toplam kullanıcı kaydı"
                    }
                },
                notifications: {
                    fetchInsights: {
                ...
                compareToLastPeriodMessage: "Son döneme göre karşılaştır"
            },      
        },
        notifications: {
            endSession: {
